...
$this->title = 'Add Building Manager';
...
if(isset($_GET['fname']) && !empty($_GET['fname']) )
{
	...
	$sql 	 = $command->insert('bmanager', array(
    				 'user_id'		=> $id,
					 'bmanager_id'	=> '',
	...
	if(!$sql)
	{
		header("Location: index.php?r=site/page&view=add-bmanager&msg=failed");
	}
	else
	{
		header("Location: index.php?r=site/page&view=add-bmanager&msg=success");
	}
...
<div class="container">
	...
	<div class="row-fluid">
           <div class="span12">
		   <h3 class="header">Add New Building Manager
	...
	<input type="hidden" name="view" value="add-bmanager">
