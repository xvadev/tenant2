...
<?php
	...
	$nr = 0;
	$cbox = 0;
	//$command  = Yii::app()->db->createCommand('SELECT tenant_id, first_name, middle_name, last_name, company, email, phone FROM tenant WHERE user_id='.$id.'')->queryAll();
    	...
    	?>
			...
			<div class="<?php if ($cbox <= 6) {
				...
				<div class="innerbox">
					...
					<a href=""><div class="tenant-but">Roomates</div></a>
					<a href=""><div class="tenant-but">Accounting</div></a>
