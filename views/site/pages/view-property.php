...
function _retrieve_property($property_id)
{
	$con = Yii::$app->db;
	$id  = Yii::$app->user->getId();

	$property = Yii::$app->db->createCommand('SELECT id, user_id, name, street, city, county, state, country, mls, built FROM property WHERE id='.$property_id.'')->queryAll();
...
function _retrieve_property_tenants($property_id)
{
	$con = Yii::$app->db;
	$id  = Yii::$app->user->getId();

	$tenants = Yii::$app->db->createCommand('SELECT * FROM tenant WHERE property_id='.$property_id.'')->queryAll();
...
else
{
	...
	$property = _retrieve_property($_GET['property']);
...
<p class="" style="color:#999999;"><?php echo $property['street'].", ".$property['city'].", ".$property['county'].", ".$property['state'].", ".$property['country']; ?></p>

<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#tenant-tab">Tenants</a></li>
    <li><a data-toggle="tab" href="#owners-tab">Owners</a></li>
    <li><a data-toggle="tab" href="#others-tab">Others</a></li>
 </ul>

 <div class="tab-content">
  <div id="tenant-tab" class="tab-pane fade">
    <h3>Tenants of this Property</h3>
    <div class="container">
	    <?php

	    	$tenants = _retrieve_property_tenants($property['id']);
			$cbox = 0;
	    	foreach ($tenants as $key => $value) {
	    		?>
				<div class="col-md-6 col-sm-6 col-xs-12">
			    <div class="well profile_view" style="padding-bottom: 146px!important;">
				...
				<div class="innerbox">
					...
					<a href=""><div class="tenant-but">Messages</div></a>
				</div>
			</div>
	    		<?php
	    	}
  ...
  <div id="owners-tab" class="tab-pane fade">
